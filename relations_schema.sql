-- Relations Schema - Add missing foreign key relations to connect all tables
-- This file adds foreign keys where relations exist but are not properly normalized

-- =============================================
-- 1. NORMALIZE LOYALTY TIERS RELATIONS
-- =============================================
